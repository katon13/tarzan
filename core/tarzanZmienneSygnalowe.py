...
play_p24_kb4 = _sygnal(
    ...
    kierunek="F",
    default="brak",
    opis="Klawiatura matrix 4x3 TARZAN, wiersz 4. Uwaga: część pełnej klawiatury 7-liniowej, nie wolno programować jako samodzielnej klawiatury USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD ROW4",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard ROW4 / LCD DB6 / Matrix LED 2 LATCH",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_ROW",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_row4",
)
...
play_p25_kb3 = _sygnal(
    ...
    kierunek="F",
    default="brak",
    opis="Klawiatura matrix 4x3 TARZAN, wiersz 3. Uwaga: część pełnej klawiatury 7-liniowej, nie wolno programować jako samodzielnej klawiatury USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD ROW3",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard ROW3 / LCD DB5 / Matrix LED 2 CLOCK",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_ROW",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_row3",
)
...
play_p26_kb2 = _sygnal(
    ...
    kierunek="F",
    default="brak",
    opis="Klawiatura matrix 4x3 TARZAN, wiersz 2. Uwaga: część pełnej klawiatury 7-liniowej, nie wolno programować jako samodzielnej klawiatury USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD ROW2",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard ROW2 / LCD DB4",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_ROW",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_row2",
)
...
play_p27_kb1 = _sygnal(
    ...
    kierunek="F",
    default="brak",
    opis="Klawiatura matrix 4x3 TARZAN, wiersz 1. Uwaga: część pełnej klawiatury 7-liniowej, nie wolno programować jako samodzielnej klawiatury USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD ROW1",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard ROW1 / GPIO pin 27",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_ROW",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_row1",
)
...
play_p42_kb_col_c = _sygnal(
    nazwa="play_p42_kb_col_c",
    plytka="PLAY",
    pin=42,
    kanal="COL_C",
    typ="LH",
    kierunek="IN",
    default="1",
    opis="Klawiatura matrix 4x3 TARZAN, kolumna C według schematu. To nie jest rezerwa; nie wolno używać jako analog/rezerwa ani mapować na USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD COL C",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard COL C / Analog capable pin 42 used as digital input",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_COL",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_col_c",
)

play_p43_kb_col_b = _sygnal(
    nazwa="play_p43_kb_col_b",
    plytka="PLAY",
    pin=43,
    kanal="COL_B",
    typ="LH",
    kierunek="IN",
    default="1",
    opis="Klawiatura matrix 4x3 TARZAN, kolumna B według schematu. To nie jest rezerwa; nie wolno używać jako analog/rezerwa ani mapować na USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD COL B",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard COL B / Analog capable pin 43 used as digital input",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_COL",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_col_b",
)

play_p44_kb_col_a = _sygnal(
    nazwa="play_p44_kb_col_a",
    plytka="PLAY",
    pin=44,
    kanal="COL_A",
    typ="LH",
    kierunek="IN",
    default="1",
    opis="Klawiatura matrix 4x3 TARZAN, kolumna A według schematu. To nie jest rezerwa; nie wolno używać jako analog/rezerwa ani mapować na USB HID.",
    zrodlo="SCHEMAT TARZAN-PCB-POKSYG-v2 / KAYBORD COL A",
    hardware_function=HW_KEYBOARD,
    hardware_label="Matrix keyboard COL A / Analog capable pin 44 used as digital input",
    pin_is_fixed=True,
    is_shared_pin=True,
    conflict_group="PLAY_KEYPAD_4X3_COL",
    panel_port=1,
    grupa="UI",
    klasa_wykonawcza="tarzanKlawiatura4x3.py",
    kanoniczna_nazwa="ui_keypad_col_a",
)
...
rec_p46_led_f1 = _sygnal(
    ...
    hardware_function=HW_GPIO,
    hardware_label="GPIO output REC P46 LED F1",
    pin_is_fixed=True,
    is_shared_pin=False,
    conflict_group=None,
    panel_port=1,
...
rec_p48_led_f2 = _sygnal(
    ...
    hardware_function=HW_GPIO,
    hardware_label="GPIO output REC P48 LED F2",
    pin_is_fixed=True,
    is_shared_pin=False,
    conflict_group=None,
    panel_port=1,
...
rec_p50_led_f3 = _sygnal(
    ...
    hardware_function=HW_GPIO,
    hardware_label="GPIO output REC P50 LED F3",
    pin_is_fixed=True,
    is_shared_pin=False,
    conflict_group=None,
    panel_port=1,
...
rec_p52_led_f4 = _sygnal(
    ...
    hardware_function=HW_GPIO,
    hardware_label="GPIO output REC P52 LED F4",
    pin_is_fixed=True,
    is_shared_pin=False,
    conflict_group=None,
    panel_port=1,
