...
#CONFIG += LIB64
#CONFIG += BUILD_WITH_LIBUSB LIB64
CONFIG += makeDLL DLL64 BUILD_WITH_LIBUSB
...
win32 {
    ...
    makeDLL {
        DLL32 {
            message("x86 build")            
            TARGET = ../../../binaries/windows/dll/32/PoKeyslib
        } else {
            message("x86_64 build")            
            TARGET = ../../../binaries/windows/dll/64/PoKeyslib
        }
    } else {
        LIB64 {
            message("x86_64 lib build")
            TARGET = ../../../binaries/windows/lib/64/PoKeysLib
        } else {
            message("x86 lib build")
            TARGET = ../../../binaries/windows/lib/32/PoKeysLib
        }
    }
}
unix:!macx {
