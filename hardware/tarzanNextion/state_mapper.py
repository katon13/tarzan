...
class TarzanNextionStateMapper:
    ...
    def snapshot(self) -> Dict[str, Any]:
        ...
        out = {
            ...
            "par_level_x": bget("sensor_level_x"),
            "par_level_y": bget("sensor_level_y"),
            "par_level_z": bget("sensor_level_z"),
            "axis_cam_h_pulses": bget("axis_cam_h_pulses"),
            "axis_cam_v_pulses": bget("axis_cam_v_pulses"),
            "axis_arm_t_pulses": bget("axis_arm_t_pulses"),
            "axis_cam_f_pulses": bget("axis_cam_f_pulses"),
            "axis_arm_h_pulses": bget("axis_arm_h_pulses"),
            "axis_arm_v_pulses": bget("axis_arm_v_pulses"),
            ...
            "io.play_action_led": bget("ui_action_led"),
            "io.rec_auto_enable": bget("ui_rec_auto_enable"),
            "io.shock_sensor": bget("sensor_shock_state"),
            "io.mass_reg_enable": bget("ui_mass_reg_enable"),
            "io.arm_h_enable": bget("axis_arm_h_en"),
            "io.arm_v_enable": bget("axis_arm_v_en"),
        }
        self._cache = out
